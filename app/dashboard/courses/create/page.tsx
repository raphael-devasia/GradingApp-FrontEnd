...
export default function CreateCoursePage() {
    ...
    async function onCreateCourse(syllabus: any) {
        setIsCreating(true)
        setError(null)
        try {
            await courseUseCases.createCourse({
                ...courseDetails,
                syllabus,
            })
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                ...
                                You'll create your syllabus in the next step.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Form {...form}>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    This will help our AI
                                                    generate a more relevant
                                                    syllabus.
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
