            ...
            <div className="hidden w-1/2 flex-col justify-between bg-mint/20 p-10 dark:bg-gray-800/50 lg:flex">
                ...
                <div className="space-y-8">
                    ...
                    <p className="text-xl text-gray-600 dark:text-gray-300">
                        The AI-powered grading assistant that saves teachers 5+
                        hours every week.
                    </p>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="font-medium text-gray-900 dark:text-white">
                                    "GradeGenie has transformed my teaching
                                    workflow. I can focus on what matters most -
                                    teaching!"
                                </p>
                ...
                <div className="text-sm text-gray-500 dark:text-gray-400">
                    © {new Date().getFullYear()} GradeGenie. All rights
                    reserved.
                </div>
            </div>
