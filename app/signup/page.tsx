...
export default function SignupPage() {
    ...
    const [selectedPlan, setSelectedPlan] = useState<
        "educator" | "department" | "institution"
    >("department")
    ...
    const paymentLinks: Record<string, Record<string, string>> = {
        educator: {
            monthly: "https://buy.stripe.com/test_cN2dTYauP6Cm0PmfZ0",
            yearly: "https://buy.stripe.com/test_bIY4jo0Uf6Cm55C3cd",
        },
        department: {
            monthly: "https://buy.stripe.com/test_00gdTY9qL9Oy55C6or",
            yearly: "https://buy.stripe.com/test_aEU6rw5av7GqapW8wA",
        },
        institution: {
            monthly: "https://buy.stripe.com/test_9AQcPUfP97GqdC8eUZ",
            yearly: "https://buy.stripe.com/test_14kcPU5avgcW55C006",
        },
    }
    ...
    const handleStripeCheckout = async () => {
        ...
        const token = localStorage.getItem("token")
        if (!token) {
            setError("You must be signed in to select a plan.")
            setStep(1)
            return
        }
                ...
                <div className="md:col-span-2 hidden md:flex flex-col justify-center space-y-8">
                    <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground">
                            Join a community of educators who are transforming
                            their classrooms with the power of AI.
                        </p>
                    </div>
                    <div className="space-y-6">
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Automate tedious tasks and focus on what you
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Provide personalized feedback that fosters
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Confidently uphold standards with advanced
                    ...
                    <div className="bg-muted p-4 rounded-lg">
                        <blockquote className="text-sm italic">
                            "GradeGenie has given me back my evenings and
                            weekends! I'm more present for my students and my
                            family."
                        </blockquote>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="text-center mb-4">
                                    <div className="inline-flex items-center rounded-full bg-mint px-3 py-1 text-sm text-gray-800 mb-2">
                                        ...
                                        <span>
                                            Your account is secure — no charges
                                            during trial
                                        </span>
                                    </div>
                                </div>
                                ...
                                >
                                    {Object.entries(
                                        plans[
                                            billingCycle as keyof typeof plans
                                        ]
                                    ).map(([planId, plan]) => (
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            <p className="font-medium">
                                                Your trial begins with full
                                                access
                                            </p>
                                            <p className="text-sm mt-1">
                                                Experience all features with no
                                                charges until your 3-day trial
                                                concludes. You maintain complete
